...
# Copy your current directory to /home/app (Why not RUN cp ../.. ../.. ? Because cp command is executed INSIDE the Container, while COPY command executes on the HOST machine. If you got some files that needed to be copied in the host machine to the container, use COPY)
COPY . /home/app
